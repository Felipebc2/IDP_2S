//Pedro Rodrigues de Araújo - 2321046
#include <stdio.h>
...
int main() {
  ...
  for(int i = 0; i < 10; i ++){
    for(int j = 0; j < 1; j ++){
      pchar2[(((i*10) + j)*4 + 1)] = 0; //pixel [i][j].Blue
      pchar2[((i*10) + j)*4 + 2] = 0; //pixel [i][j].Green
      pchar2[((i*10) + j)*4 + 3] = 255; //pixel [i][j].Red
    }
    for(int j = 0; j < 10; j += 9){
      pchar2[(((j*10) + i)*4 + 1)] = 0; //pixel [i][j].Blue
      pchar2[((j*10) + i)*4 + 2] = 0; //pixel [i][j].Green
      pchar2[((j*10) + i)*4 + 3] = 255; //pixel [i][j].Red
    }
    for(int j = 9; j < 10; j ++){
      pchar2[(((i*10) + j)*4 + 1)] = 0; //pixel [i][j].Blue
      pchar2[((i*10) + j)*4 + 2] = 0; //pixel [i][j].Green
  ...
  for(int i = 0; i < 10; i ++){
    for(int j = 0; j < 10; j ++){
      if(i == j) {
        pchar3[(((i*10) + j)*4 + 1)] = 255; //pixel [i][j].Blue
        pchar3[((i*10) + j)*4 + 2] = 0; //pixel [i][j].Green
        pchar3[((i*10) + j)*4 + 3] = 0; //pixel [i][j].Red

        pchar3[(((10 - i)*10 - (10 - j))*4 + 1)] = 255; //pixel [i][j].Blue
        pchar3[(((10 - i)*10 - (10 - j))*4 + 2)] = 0; //pixel [i][j].Green
        pchar3[(((10 - i)*10 - (10 - j))*4 + 3)] = 0; //pixel [i][j].Red
      }
    }
  }
  //insira o seu código acima
  ...
  for (int i = 0; i < 10; i++){
    for (int j = 0; j < 10; j++){
      pchar4[(i * 10*4) + (j * 4)] = pchar3[(i * 10*4) + (j * 4)];
      pchar4[(i * 10*4) + (j * 4) + 1] = pchar3[(i * 10*4) + (j * 4) + 1];
      pchar4[(i * 10*4) + (j * 4) + 2] = pchar3[(i * 10*4) + (j * 4) + 2];
      pchar4[(i * 10*4) + (j * 4) + 3] = pchar3[(i * 10*4) + (j * 4) + 3];
    }
  }
  ...
  for (int i = 0; i < 10; i++){
    for (int j = 0; j < 10; j++){
      if (i == 0 || i == 9){
        pchar4[(i * 10*4) + (j * 4) + 1] = pchar2[(i * 10*4) + (j * 4) + 1];
        pchar4[(i * 10*4) + (j * 4) + 2] = pchar2[(i * 10*4) + (j * 4) + 2];
        pchar4[(i * 10*4) + (j * 4) + 3] = pchar2[(i * 10*4) + (j * 4) + 3];
      }
      else if (j == 0 || j == 9){
        pchar4[(i * 10*4) + (j * 4) + 1] = pchar2[(i * 10*4) + (j * 4) + 1];
        pchar4[(i * 10*4) + (j * 4) + 2] = pchar2[(i * 10*4) + (j * 4) + 2];
